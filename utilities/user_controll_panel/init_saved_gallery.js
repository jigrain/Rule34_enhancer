...
modal_gallery_manager.setAttribute('id', 'main-modal-window');
...
function renderGalleries(items, page, maxPerPage) {
    ...
    currentItems.forEach(item => {
        ...
        if (item.content.length > 0) {
            ...
            image.src = firstContentItem.url;
            image.alt = firstContentItem.type === 'video' ? 'image' : 'image';
        } else {
